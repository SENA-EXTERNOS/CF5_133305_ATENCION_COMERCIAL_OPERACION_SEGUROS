  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.ampliar-3.fondo-tema3.margen-fondo-tema3.px-5
      ...
      .row.justify-content-center
        .col-lg-3
          figure
            img(src='@/assets/curso/temas/tema-3/tema3-img6.1.svg', alt='Texto que describa la imagen').img.tarjeta-tema-1-2
          ...
          TabsA.color-secundario.mt-5
            .tarjeta.color-secundario--borde.p-4(titulo="Resumen de ventas")
              .row
                .col-lg-4.mt-4
                  figure
                    img(src='@/assets/curso/temas/tema-3/tema3-img6.svg', alt='Texto que describa la imagen').img.tarjeta-tema-1-2
                .col-lg-8
            ...
            .tarjeta.color-secundario--borde.p-4(titulo="Ganancias y pérdidas")
              .row
                .col-lg-4.mt-3
                  figure
                    img(src='@/assets/curso/temas/tema-3/tema3-img7.svg', alt='Texto que describa la imagen').img.tarjeta-tema-1-2
                .col-lg-8
            ...
            .tarjeta.color-secundario--borde.p-4(titulo="Información de los clientes")
              .row
                .col-lg-4.mt-4
                  figure
                    img(src='@/assets/curso/temas/tema-3/tema3-img8.svg', alt='Texto que describa la imagen').img.tarjeta-tema-1-2
                .col-lg-8
                  h2.mt-4 Información de los clientes
                  p.mt-3 En una de las gestiones vitales del área de ventas, permite establecer relaciones de confianza con los clientes y, al mismo tiempo, generar estrategias de fidelización con los clientes.
