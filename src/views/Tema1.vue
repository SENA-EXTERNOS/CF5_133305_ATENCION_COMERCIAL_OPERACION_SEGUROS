        ...
        .tarjeta.tarjeta-slide.arriba.color-acento-contenido(@mouseover="indicadorTarjetaSlide = false")
          ...
          .tarjeta-slide__contenedor
            .tarjeta-slide__contenido.p-4.p-xl-5
              p Creación de normas y políticas de expedición en cada rama de los seguros., 
      ...
      .col-sm-6.col-xl-3.mb-4.mb-xl-0
        .tarjeta.tarjeta-slide.arriba.color-acento-contenido(@mouseover="indicadorTarjetaSlide = false")
          .tarjeta-slide__contenedor
            ...
            .tarjeta-slide__contenido.p-4.p-xl-5
              p Definir las normas que permitan describir los suplementos de los seguros.
      ...
      .col-sm-6.col-xl-3.mb-4.mb-sm-0
        .tarjeta.tarjeta-slide.arriba.color-acento-contenido(@mouseover="indicadorTarjetaSlide = false")
          .tarjeta-slide__contenedor
            ...
            .tarjeta-slide__contenido.p-4.p-xl-5
              p Vigilar y monitorear que se cumplan las normas de expedición, antes que sea aceptado el riesgo.
      ...
      .col-sm-6.col-xl-3
        .tarjeta.tarjeta-slide.arriba.color-acento-contenido(@mouseover="indicadorTarjetaSlide = false")
          .tarjeta-slide__contenedor
            ...
            .tarjeta-slide__contenido.p-4.p-xl-5
              p  Ofrecer alternativas de atención al cliente, derivadas de la interpretación de las condiciones generales y particulares, propias de la póliza.
